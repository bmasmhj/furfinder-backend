...
export default function HeroSection() {
  return (
    <section className="hero">
      <div className="max-w-7xl m-auto flex justify-between gap-x-24">
        <div className='flex flex-col justify-center md:justify-start gap-6'>
          ...
          <h1 className=''>
            Helping bring <span className="accent">lost pets</span> home,
            faster.
          </h1>
          <p className="sub">
        ...
        <div className='hidden md:block'>
            <Image src={Mobile} alt="Mobile app" width={300} height={500} />
        </div>
      </div>
    </section>
  );
