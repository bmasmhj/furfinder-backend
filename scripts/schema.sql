-- Pet Reunite AI Database Schema
-- Extension-free UUID Schema
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  profile_id UUID REFERENCES pet_profiles(id) ON DELETE CASCADE,
...
-- Create organisation_animals table
