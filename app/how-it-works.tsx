      ...
      >
        ...
        >
          ...
          <Text style={styles.heroSubtitle}>
            Australia's first AI-powered pet recovery app. Smart photo matching, biometric scanning, and community alerts working together to reunite lost pets faster.
          </Text>
        </LinearGradient>
